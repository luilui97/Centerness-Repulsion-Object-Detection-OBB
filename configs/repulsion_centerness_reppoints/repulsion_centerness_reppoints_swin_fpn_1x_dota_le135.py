...
# @Author  : Lei Gao
# @FileName: repulsion_reppouints_r50_fpn_1x_dota_le135.py
# @Software: PyCharm
_base_ = [
    '../_base_/datasets/dotav1.py', '../_base_/schedules/schedule_swin.py',
...
model = dict(
    ...
    neck=dict(
        ...
        norm_cfg=norm_cfg),
    bbox_head=dict(
        type='RepulsionOrientedRepPointsHead',
        num_classes=15,
        in_channels=256,
        feat_channels=256,
        ...
        repulsion_loss = dict(type='RepulsionReppointsLoss',loss_weight=0.25,part_weight=[1.0,0.5,0.5]),
        init_qua_weight=0.2,
        top_ratio=0.4),
